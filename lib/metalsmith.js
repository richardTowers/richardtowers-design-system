...
// extract page headings
  ...
  // copy static assets from node_modules/@richardtowersfrontend
  .use(assets({
    source: '../' + paths.richardtowersfrontend + 'govuk/assets/',
    destination: 'assets'
  }))
  ...
  .use(rollup({
    input: 'src/javascripts/richardtowers-frontend.js',
    output: {
      legacy: true,
      format: 'iife',
      file: 'javascripts/richardtowers-frontend.js'
    },
    plugins: [
      // TODO: Since we're not exporting ES6 Modules to NPM we need to import these as commonjs
      resolve(),
  ...
  .use(uglify({
    ...
    files: [
      ...
      'javascripts/richardtowers-frontend.js',
