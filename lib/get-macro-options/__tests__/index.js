...
const fixtures = {
  'node_modules/richardtowers-frontend/src/govuk/components/radios/macro-options.json': [
    {
  ...
  'node_modules/richardtowers-frontend/src/govuk/components/input/macro-options.json': [
    {
